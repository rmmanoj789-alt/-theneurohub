...
const WHATSAPP = `https://wa.me/${WHATSAPP_NUM}?text=Hi,%20I%20would%20like%20to%20know%20more%20about%20neurotherapy%20at%20The%20Neuro%20Hub%20Wellness%20Centre.`;
...
export default function Contact() {
  return (
    <section id="contact" className="py-16 md:py-28 bg-white pb-28 md:pb-28">
      <div className="max-w-7xl mx-auto section-padding">
        ...
        >
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold text-navy-900 leading-tight mb-4">
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-stretch">
          ...
          >
            ...
            <a
              href={`tel:${PHONE}`}
              className="group flex items-start gap-3 sm:gap-5 p-4 sm:p-6 rounded-2xl bg-gradient-to-r from-teal-50 to-white border border-teal-100 hover:shadow-elevated hover:border-teal-200 transition-all"
            >
              <div className="w-11 h-11 sm:w-14 sm:h-14 rounded-2xl bg-gradient-to-br from-teal-500 to-brand-600 flex items-center justify-center shadow-glow shrink-0">
            ...
            >
              <div className="w-11 h-11 sm:w-14 sm:h-14 rounded-2xl bg-gradient-to-br from-emerald-500 to-teal-600 flex items-center justify-center shadow-glow shrink-0">
            ...
            >
              <div className="w-11 h-11 sm:w-14 sm:h-14 rounded-2xl bg-gradient-to-br from-rose-500 to-pink-600 flex items-center justify-center shadow-glow shrink-0">
            ...
            >
              <div className="w-11 h-11 sm:w-14 sm:h-14 rounded-2xl bg-gradient-to-br from-brand-500 to-brand-700 flex items-center justify-center shadow-glow shrink-0">
            ...
            {/* Hours */}
            <div className="flex items-start gap-3 sm:gap-5 p-4 sm:p-6 rounded-2xl bg-slate-50 border border-slate-100">
              <div className="w-11 h-11 sm:w-14 sm:h-14 rounded-2xl bg-slate-200 flex items-center justify-center shrink-0">
            ...
            <a
              ...
              className="group flex items-start gap-3 sm:gap-5 p-4 sm:p-6 rounded-2xl bg-gradient-to-r from-teal-600 to-brand-800 text-white hover:shadow-glow transition-all"
            >
              <div className="w-11 h-11 sm:w-14 sm:h-14 rounded-2xl bg-white/20 flex items-center justify-center shrink-0">
          ...
          >
            ...
            <div className="px-4 sm:px-6 py-4 sm:py-5 bg-white/80 backdrop-blur-sm border-t border-slate-100">
              <div className="flex items-start gap-3 mb-3">
                <MapPin className="w-5 h-5 text-teal-600 shrink-0 mt-0.5" />
                <div className="min-w-0">
                  <p className="font-bold text-navy-900 text-sm sm:text-base">The Neuro Hub Wellness Centre</p>
                  <p className="text-xs sm:text-sm text-navy-600">Sundarapuram, Coimbatore, Tamil Nadu, India</p>
