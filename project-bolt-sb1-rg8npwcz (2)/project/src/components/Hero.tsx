...
export default function Hero() {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center overflow-hidden gradient-hero">
      ...
      <div className="relative z-10 w-full section-padding pt-28 sm:pt-32 pb-20 sm:pb-20 md:pt-40 md:pb-28">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <motion.h1
                ...
                className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl xl:text-7xl font-extrabold text-white leading-[1.15] tracking-tight mb-6"
              >
              ...
              <motion.div
                ...
                className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center lg:justify-start gap-2 mb-6"
              >
                <a
                  href={`tel:${PHONE}`}
              ...
              <motion.div
                ...
                className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center lg:justify-start gap-2"
              >
            ...
            <motion.div
              ...
              className="relative hidden lg:flex items-center justify-center min-w-0"
            >
              {/* Decorative rings */}
